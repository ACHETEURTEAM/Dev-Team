...
/**
 * Class ProductActionApprove
 */
class ProductActionApprove extends Column
{
            ...
            foreach ($dataSource['data']['items'] as $key => $item) {
                ...
                switch ($item['check_status']) {
                    case Vproducts::APPROVED_STATUS:
                        ...
                        $dataSource['data']['items'][$key]['actions_approve'] = $html;
                        break;
                    ...
                    title="' . __("Click to Approve") . '" onclick="if(confirm(\'Are you sure, You want to approve?\')){ setLocation(\'' . $this->urlBuilder->getUrl(
                ...
                onclick="if(confirm(\'Are you sure, You want to approve?\')){ setLocation(\'' . $this->urlBuilder->getUrl(
                    'csmarketplace/vproducts/changeStatus/status/1/id/' .
                        $item['entity_id']
                ) . '\'); } else { return false; }; 
              ">' . __("Approve") . '</a>';
     ...
     * @return string
     */
    public function getReasonHtml($url, $id)
    {
