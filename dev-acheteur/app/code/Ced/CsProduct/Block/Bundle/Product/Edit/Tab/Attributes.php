...
use Ced\CsProduct\Block\Product\Edit\Tab\Attributes as TabAttributes;
use Magento\Catalog\Model\Product;

class Attributes extends TabAttributes
{
    /**
    ...
    protected function _prepareForm()
    {
        ...
        if ($tier_price) {
            $tier_price->setRenderer(
                $this->getLayout()->createBlock(
                    \Ced\CsProduct\Block\Product\Edit\Tab\Price\Tier::class
