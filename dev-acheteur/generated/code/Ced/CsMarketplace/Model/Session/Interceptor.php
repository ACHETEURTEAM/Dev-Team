...
class Interceptor extends \Ced\CsMarketplace\Model\Session implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getVendorId');
        return $pluginInfo ? $this->___callPlugins('getVendorId', func_get_args(), $pluginInfo) : parent::getVendorId();
    }
