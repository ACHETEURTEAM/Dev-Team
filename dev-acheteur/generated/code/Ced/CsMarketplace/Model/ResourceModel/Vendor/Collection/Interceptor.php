<?php
namespace Ced\CsMarketplace\Model\ResourceModel\Vendor\Collection;

/**
 * Interceptor class for @see \Ced\CsMarketplace\Model\ResourceModel\Vendor\Collection
 */
class Interceptor extends \Ced\CsMarketplace\Model\ResourceModel\Vendor\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Ced\CsMarketplace\Model\ResourceModel\Vorders\CollectionFactory $vOrderCollectionFactory, \Magento\Framework\Data\Collection\EntityFactory $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, \Magento\Eav\Model\Config $eavConfig, \Magento\Framework\App\ResourceConnection $resource, \Magento\Eav\Model\EntityFactory $eavEntityFactory, \Magento\Eav\Model\ResourceModel\Helper $resourceHelper, \Magento\Framework\Validator\UniversalFactory $universalFactory, \Magento\Framework\Model\ResourceModel\Db\VersionControl\Snapshot $entitySnapshot, \Magento\Framework\App\Request\Http $httprequest, $modelName = 'Ced\\CsMarketplace\\Model\\Vendor', ?\Magento\Framework\DB\Adapter\AdapterInterface $connection = null)
    {
        $this->___init();
        parent::__construct($vOrderCollectionFactory, $entityFactory, $logger, $fetchStrategy, $eventManager, $eavConfig, $resource, $eavEntityFactory, $resourceHelper, $universalFactory, $entitySnapshot, $httprequest, $modelName, $connection);
    }
    ...
    public function toOptionArray($vendor_id = 0)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('toOptionArray', func_get_args(), $pluginInfo) : parent::toOptionArray($vendor_id);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'toOptionpayArray');
        return $pluginInfo ? $this->___callPlugins('toOptionpayArray', func_get_args(), $pluginInfo) : parent::toOptionpayArray();
    }
