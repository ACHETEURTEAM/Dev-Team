...
class Interceptor extends \Ced\CsMarketplace\Model\ResourceModel\Vendor implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\Module\Manager $moduleManager, \Magento\Eav\Model\Entity\Context $context, $data = [])
    {
        $this->___init();
        parent::__construct($moduleManager, $context, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'deleteFromGroup');
        return $pluginInfo ? $this->___callPlugins('deleteFromGroup', func_get_args(), $pluginInfo) : parent::deleteFromGroup($vendor);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'groupVendorExists');
        return $pluginInfo ? $this->___callPlugins('groupVendorExists', func_get_args(), $pluginInfo) : parent::groupVendorExists($vendor);
    }
    ...
    public function add(\Magento\Framework\Model\AbstractModel $vendor)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('add', func_get_args(), $pluginInfo) : parent::add($vendor);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'hasAssigned2Group');
        return $pluginInfo ? $this->___callPlugins('hasAssigned2Group', func_get_args(), $pluginInfo) : parent::hasAssigned2Group($vendor);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'vendorExists');
        return $pluginInfo ? $this->___callPlugins('vendorExists', func_get_args(), $pluginInfo) : parent::vendorExists($vendor);
    }
